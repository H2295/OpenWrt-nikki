...
return view.extend({
    ...
    render: function (data) {
        ...
        poll.add(function () {
            return L.resolveDefault(nikkibox.status()).then(function (running) {
        ...
        o.onclick = function () {
            return nikkibox.upgrade().then(function(res) {
				if (res.success) {
